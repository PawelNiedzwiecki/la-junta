...
const LANG_LABEL: Record<"es" | "en", string> = {
	es: "Spanish (ES)",
	en: "English (EN)",
};
...
export function UploadCard({
	...
	return (
		...
		>
			...
			>
				...
				<div className="flex flex-col gap-2">
					<h2
						...
						style={{ color: "var(--color-cream)" }}
					>
						{unlocked ? `${LANG_LABEL[lang]} menu` : "Admin"}
					</h2>
					<p
			...
			>
				{/* Password — only on first card, hidden once unlocked */}
					...
					<div className="flex flex-col gap-2">
						...
						>
							...
							<button
								...
								className="w-full rounded-lg px-4 py-3 text-[0.88rem] font-medium transition-opacity"
								style={{
				...
				{/* Drop zone — only shown when unlocked */}
				{unlocked && (
					<>
						<button
							type="button"
